...
if($form->settings['feature_image']){
    ...
    $feature_image_src = AUTO_MAIL_URL . 'assets/images/form/default-commerce-feature.png';
}

?>
<div id="modal-<?php echo $form->id;?>" class="modal commerce-template">
                ...
                <div class="am-form-content">
                    <div class="am-form-content-wrap">
                        ...
                        <div class="am-form-group-content">
                            <p><?php echo esc_html($form->settings['auto_mail_message']); ?></p>
                        </div>
                    </div>
                    <form method="post" class="am-subscribe-form-data">
                        ...
                        <div class="am-form-submit">
                            <button class="am-form-button am-submit-form-button">
                                <span class="am-form-button-text"><?php esc_html_e( 'Get Beta Access', Auto_Mail::DOMAIN ); ?></span>
                            </button>
                        </div>
