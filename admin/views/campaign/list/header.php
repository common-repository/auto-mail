<h1 class="auto-mail-header-title"><?php esc_html_e( 'Campaigns', Auto_Mail::DOMAIN ); ?></h1>
<div class="auto-mail-actions-left">
    <a href="<?php echo admin_url( 'admin.php?page=auto-mail-campaign-wizard' ); ?>" class="auto-mail-campaign-builder">
