        ...
        <div class="auto-mail-pagination-desktop auto-mail-box">
            <div class="auto-mail-box-search">
                <form method="post" name="auto-mail-bulk-action-form" class="auto-mail-search-left">
                    <input type="hidden" name="auto_mail_nonce" value="<?php echo wp_create_nonce( 'auto-mail-automation-request' );?>">
                    <input type="hidden" name="_wp_http_referer" value="<?php admin_url( 'admin.php?page=auto-mail-automation' ); ?>">
                    <input type="hidden" name="ids" id="auto-mail-select-automations-ids" value="">
                    <label for="auto-mail-check-all-automations" class="auto-mail-checkbox">
                        <input type="checkbox" id="auto-mail-check-all-automations">
                ...
                <div class="auto-mail-accordion-item-header">
                    ...
                    <div class="auto-mail-accordion-item-title auto-mail-trim-title">
                        <label for="wpf-module-<?php echo esc_attr( $module['id'] ); ?>" class="auto-mail-checkbox auto-mail-accordion-item-action">
                            <input type="checkbox" id="wpf-module-<?php echo esc_attr( $module['id'] ); ?>" class="auto-mail-check-single-automation" value="<?php esc_attr_e( $module['id'] ); ?>">
                            <span aria-hidden="true"></span>
                        ...
                        <span class="auto-mail-trim-text">
                            <?php echo auto_mail_get_automation_name( $module['id'] ); ?>
                        </span>
                        <?php
                    ...
                    <div class="auto-mail-accordion-col-auto">
                        ...
                        <a href="<?php echo admin_url( 'admin.php?page=auto-mail-automation-wizard&id=' . $module['id'] . '&status=' . $module['status'] ); ?>"
...
<div class="auto-mail-box auto-mail-message auto-mail-message-lg">
    ...
    <div class="auto-mail-message-content">
        ...
        <p><?php esc_html_e( 'Create social feed automation for all your needs with customized settings.', Auto_Mail::DOMAIN ); ?></p>

        <p>
            <a href="<?php echo admin_url( 'admin.php?page=auto-mail-generator') ?>" >
