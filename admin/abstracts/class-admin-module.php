...
if ( ! class_exists( 'Auto_Mail_Admin_Module' ) ) :

abstract class Auto_Mail_Admin_Module {
	...
	/**
	 * Auto_Mail_Admin_Module constructor.
	 *
	 * @since 1.0
	 */
