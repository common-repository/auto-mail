...
class AM_Automation_Woo_Schedule_Email extends AM_Automation_Integration_Action {

    public $integration = 'wooocommerce';
    public $action = 'woo_schedule_email';
...
new AM_Automation_Woo_Schedule_Email();