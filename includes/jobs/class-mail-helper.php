...
if ( file_exists( ABSPATH . WPINC . '/PHPMailer/PHPMailer.php' ) ) :
	...
	class _auto_mail_SMTP extends SMTP {};
	class _auto_mail_mail_helper extends PHPMailer {};
	class _auto_mail_phpmailerException extends phpmailerException {};
...
class auto_mail_mail_helper extends _auto_mail_mail_helper {
	...
	public function __construct( $exceptions = false ) {
		...
		$this->XMailer     = 'AutoMail ' . self::VERSION . ' (' . $this->Version . ')';
		$this->CharSet     = auto_mail_option( 'charset', 'UTF-8' );
		$this->Encoding    = auto_mail_option( 'encoding', '8bit' );
		$this->Ical        = apply_filters( 'auto_mail_ical', '' );
		$this->SMTPDebug   = 0; // 0 = off, 1 = commands, 2 = commands and data
		$this->SMTPOptions = apply_filters(
			'mymail_smtp_options',
			apply_filters( 'auto_mail_smtp_options', auto_mail_option( 'allow_self_signed' ) )
			? array(
				'ssl' => array(
					'verify_peer'       => false,
	...
	public static function ValidateAddress( $address, $patternselect = 'auto' ) {
		return auto_mail_is_email( $address );
	}
	...
	public function PreSend() {
		...
		} catch ( _auto_mail_phpmailerException $e ) {
