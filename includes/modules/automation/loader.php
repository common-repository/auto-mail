...
if ( ! class_exists( 'Auto_Mail_Automation' ) ) :

class Auto_Mail_Automation extends Auto_Mail_Module {
	...
	public function load_admin() {
		if( is_admin() ) {
			...
			new Auto_Mail_Automation_Admin();
		}
	}
	...
	public function register_cpt() {
		$labels = array(
			'name'          => $this->get_option('AM_Automations'),
			'singular_name' => $this->get_option('am_automation')
		);
		...
		register_post_type( 'am_automations', $args );
	}
	...
	public function options() {
		return array(
			'name'          => esc_html__('Custom Automations', Auto_Mail::DOMAIN),
			'singular_name' => esc_html__('Custom Automation', Auto_Mail::DOMAIN),
			...
			'button_label'  => esc_html__( "New Custom Automation", Auto_Mail::DOMAIN ),
