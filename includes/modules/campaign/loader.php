...
if ( ! class_exists( 'Auto_Mail_Campaign' ) ) :

class Auto_Mail_Campaign extends Auto_Mail_Module {
	...
	public function register_cpt() {
		...
		$labels = array(
			'name'          => $this->get_option('AM_Campaigns'),
			'singular_name' => $this->get_option('am_campaign')
		);
		...
		register_post_type( 'am_campaigns', $args );
	}
	...
	public function options() {
		return array(
			'name'          => esc_html__('Custom Campaigns', Auto_Mail::DOMAIN),
			'singular_name' => esc_html__('Custom Campaign', Auto_Mail::DOMAIN),
			...
			'button_label'  => esc_html__( "New Custom Campaign", Auto_Mail::DOMAIN ),
