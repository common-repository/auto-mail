...
if ( ! class_exists( 'Auto_Mail_List' ) ) :

class Auto_Mail_List extends Auto_Mail_Module {
	...
	public function register_cpt() {
		...
		$labels = array(
			'name'          => $this->get_option('AM_Lists'),
			'singular_name' => $this->get_option('am_list')
		);
		...
		register_post_type( 'am_lists', $args );
	}
	...
	public function options() {
		return array(
			'name'          => esc_html__('Custom Lists', Auto_Mail::DOMAIN),
			'singular_name' => esc_html__('Custom List', Auto_Mail::DOMAIN),
			...
			'button_label'  => esc_html__( "New Custom List", Auto_Mail::DOMAIN ),
