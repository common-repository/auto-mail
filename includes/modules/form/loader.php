...
if ( ! class_exists( 'Auto_Mail_Form' ) ) :

class Auto_Mail_Form extends Auto_Mail_Module {
	...
	public function register_cpt() {
		$labels = array(
			'name'          => $this->get_option('AM_Forms'),
			'singular_name' => $this->get_option('am_form')
		);
		...
		register_post_type( 'am_forms', $args );
	}
	...
	public function options() {
		return array(
			'name'          => esc_html__('Custom Forms', Auto_Mail::DOMAIN),
			'singular_name' => esc_html__('Custom Form', Auto_Mail::DOMAIN),
			...
			'button_label'  => esc_html__( "New Custom Form", Auto_Mail::DOMAIN ),
